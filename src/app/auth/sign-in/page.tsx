...
function SignInForm() {
  ...
  async function signInWithGoogle() {
    ...
    try {
      ...
      setNotice("Account sign-in is not configured.");
    } finally {
      setBusy(false);
    }
  }
    ...
    try {
      ...
      setNotice(
        error
          ...
          : "If that address can receive Atlas sign-in email, a link is on its way."
      );
    } catch {
      setNotice("Account sign-in is not configured.");
    } finally {
    ...
    <main className="container py-12">
      <section className="mx-auto max-w-md space-y-6">
        <div>
          ...
          <h1 className="text-3xl font-semibold">Sign in to Atlas</h1>
          <p className="text-muted-foreground mt-2">
            Accounts are optional. You can continue exploring public Atlas
