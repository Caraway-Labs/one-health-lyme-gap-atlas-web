...
export const privacyRequestStatusDownloadAvailableDefault = false;
export const PrivacyRequestStatus = zod.object({
  ...
  "download_available": zod.boolean().default(privacyRequestStatusDownloadAvailableDefault),
...
export type PrivacyRequestStatus = zod.input<typeof PrivacyRequestStatus>;
export type PrivacyRequestStatusOutput = zod.output<typeof PrivacyRequestStatus>;
