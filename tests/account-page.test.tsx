...
vi.mock(import("../src/generated/atlas"), () => ({
  ...
  confirmPrivacyRequestV1MePrivacyRequestsRequestIdConfirmPost: vi.fn<
    () => Promise<never>
  >(),
  downloadPrivacyExportV1MePrivacyRequestsRequestIdExportGet: vi.fn<
    () => Promise<never>
  >(),
}));
...
describe("account page", () => {
  ...
  it("uses shared select primitives for optional profile fields", async () => {
    ...
    expect(screen.getByRole("button", { name: "Remove all data" })).toBeTruthy();
  });
});
